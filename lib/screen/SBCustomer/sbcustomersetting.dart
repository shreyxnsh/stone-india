...
class SBCustomerSettingScreen extends StatefulWidget {
  ...
  @override
  _SBCustomerSettingScreenState createState() =>
      _SBCustomerSettingScreenState();
}
...
class _SBCustomerSettingScreenState extends State<SBCustomerSettingScreen> {
  ...
  Widget build(BuildContext context) {
    var viewOnLogin = SingleChildScrollView(
                        ...
                        children: [
                          ...
                          AppSettingItemWidget(
                              ...
                              onTap: () {
                                if (Platform.isAndroid) {
                                  Share.share(
                                      'Check out the Stone India Application!\n\n${"${playStoreBaseURL}com.stoneindia.stoneindia"}');
                                }
                                if (Platform.isIOS) {
                                  Share.share(
                                      'Check out the Stone India Application!\n\n${"${appStoreBaseURL}com.stoneindia.stoneindia"}');
                            ...
                            onTap: () async {
                              showConfirmDialogCustom(
                                ...
                                onAccept: (c) async {
                                  ...
                                  push(const SignInScreen(isfirst: false),
                                      isNewTask: true,
                                      pageRouteAnimation:
                          ...
                          AppSettingItemWidget(
                            ...
                            onTap: () async {
                              showConfirmDialogCustom(
                                ...
                                title:
                                    'Are You Sure you wants to close your account'
                                    '?',
                              );
                            },
                          )
            ...
            : Center(
                child: Column(
                  ...
                  children: [
                    ...
                    16.height,
                    Text(
                      'Please Login to access the settings',
                      style: boldTextStyle(size: 20),
                    ),
                    16.height,
                    AppButton(
