...
class CustomerHoldScreen extends StatefulWidget {
  const CustomerHoldScreen({super.key});

  @override
  _CustomerHoldScreenState createState() => _CustomerHoldScreenState();
}

class _CustomerHoldScreenState extends State<CustomerHoldScreen> {
  ...
  init() async {
    ...
    await fetchcustomerholdblockform(
            last_id: null, user_id: getIntAsync(USER_ID))
        .then((value) {
              ...
              child: Column(
                children: [
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              CommonRowWidget(
                                title: 'Total Slabs: ',
                                value: holdlist[index].total_slabs.validate(),
                              ),
                              CommonRowWidget(
                                title: 'Total Sq ft: ',
                                value:
                  ...
                  Row(
                    ...
                    children: [
                      // Spacer(),
                      // if (getStringAsync(USER_ROLE) == UserRoleStoneBharatTeam && holdlist![index].form_status == "On Hold")
                      //   Container(
                      //     decoration: boxDecorationWithRoundedCorners(boxShape: BoxShape.circle, backgroundColor: kPrimaryColor),
                      //     padding: EdgeInsets.all(10),
                      //     child: Image.asset("assets/icons/unhold.png", width: 20, height: 20, fit: BoxFit.cover, color: white),
                      //   ).onTap(() async{
                      ...
                      //       onAccept: (c) async {
                      //         await unholdblock(
                      //             form_id: holdlist![index].id).then((value) async {
                      ...
                      //       },
                      //
                      //       title: 'Are you sure you wants to mark unhold to this block data' + '?',
                      //     );
                      //   }
                      //   ),
                      // 24.width,
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      getStatusData(holdlist[index]
                                          ...
                                          .validate())!,
                                      style:
                                          boldTextStyle(size: 12, color: white),
                                    ),
                                  ),
                                )
                            ],
            ...
            if (getStatusData(holdlist[index].form_status.validate())! != '')
              Positioned(
                ...
                child: Container(
                  ...
                  child: Text(
                      getStatusData(holdlist[index].form_status.validate())!,
  ...
  Widget body() {
    return Column(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [Expanded(child: listdata())],
    );
  }
