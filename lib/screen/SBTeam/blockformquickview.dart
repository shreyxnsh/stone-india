              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    CommonRowWidget(
                        title: 'Form Type: ',
                        value: blockFormData!.form_type!
                            .validate()
                            .capitalizeFirstLetter()),
                    CommonRowWidget(
                        title: 'Block Number: ',
                        value: blockFormData!.block_name!.validate()),
                    CommonRowWidget(
                        title: 'Product Name: ',
                        value: blockFormData!.product_name!.validate()),
                    CommonRowWidget(
                        title: 'Category: ',
                        value: blockFormData!.category_name!.validate()),
                    CommonRowWidget(
                        title: 'Slab Type: ',
                        value: blockFormData!.slab_type_name!.validate()),
                    CommonRowWidget(
                        title: "Slab Size: ",
                        value:
                            "${blockFormData!.slab_length.validate()}x${blockFormData!.slab_height.validate()} (In Inch)"),
                    CommonRowWidget(
                      title: 'Slab Thickness: ',
                      value:
                          ' ${blockFormData!.slab_thickness.validate()} (In Cm)',
                    ),
                    CommonRowWidget(
                      title: 'Total Sq ft: ',
                      value:
                          '${((int.parse(blockFormData!.total_slabs.validate()) * int.parse(blockFormData!.slab_length.validate()) * int.parse(blockFormData!.slab_height.validate())).toInt() / 144).toInt()}',
                    ),
                    CommonRowWidget(
                        title: "Total Slab: ",
                        value: blockFormData!.total_slabs.validate()),
                  ],
                ),
                24.height,
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        StoneNavigate.to(QuickViewImagesWidget(
                            blockFormImages: blockFormData!.images));
                      },
                      child: Container(
